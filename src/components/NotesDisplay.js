...
const NotesDisplay = ({ notes, onRegenerate }) => {
    ...
    return (
        <motion.div
            ...
            className="mt-8 mb-24 w-full max-w-full sm:max-w-full md:max-w-full lg:max-w-full xl:max-w-full p-4 sm:px-6 md:px-8 bg-neutral-950 text-beige rounded-md xs:max-w-[70%]"
        >
