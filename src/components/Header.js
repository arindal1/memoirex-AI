...
const Header = ({ onContinue }) => {
    return (
        ...
        >
        <h1 className="font-raleway text-beige text-[6.75rem] sm:text-6xl md:text-[6.75rem] xs:text-[5rem]">
        ...
        <button
            onClick={onContinue}
            className="mt-6 bg-beige text-dark px-4 py-2 rounded-md text-2xl font-medium transition-transform duration-300 hover:scale-105"
        >
            continue
        </button>
        </motion.div>
